...
import murach.data.UserIO_down;
...
public class DownloadServlet extends HttpServlet {
    ...
    private String checkUser(HttpServletRequest request,
        ...
        User_ch05_ex1 user = (User_ch05_ex1) session.getAttribute("user");
        ...
        if (user == null) {
            ...
            // if cookie exists, create User object and go to Downloads page
                ...
                String path = sc.getRealPath("/WEB-INF/EmailList1.txt");
                user = UserIO_down.getUser(emailAddress, path);
