...
@WebServlet("/email0601")
public class EmailListServlet_ch06_ex1 extends HttpServlet {

    @Override
    protected void doPost(HttpServletRequest request,
            HttpServletResponse response)
            throws ServletException, IOException {
        String url = "/ch06_ex1_email.jsp";
        ...
        if (action.equals("join")) {
            url = "/ch06_ex1_email.jsp";    // the "join" page
        } 
            ...
            if (firstName == null || lastName == null || email == null ||
                ...
                url = "/ch06_ex1_email.jsp";
            } 
            else {
                message = "";
                url = "/thanks_ch06_ex1.jsp";
                //UserDB.insert(user);
            }
